...
RK_S32 test_rgn_overlay_text_process(int sX ,int sY, char* text, int group) {
	printf("========%s========\n", __func__);
	RK_S32 s32Ret = RK_SUCCESS;
	...
	*********************************************/
	...
	set_argb8888_text((RK_U32 *)ColorData, 0, 0, text, TEST_ARGB32_GREEN);
